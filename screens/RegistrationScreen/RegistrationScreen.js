...
import { ImageBackground, StyleSheet, View, Text, TextInput, Pressable, KeyboardAvoidingView, Platform } from "react-native";
            ...
            <ImageBackground source={require('../../assets/images/bg.webp')} style={styles.image} resizeMode="cover">
                <KeyboardAvoidingView behavior={Platform.OS === "ios" ? "padding" : "height"}>
                    <View style={[styles.form, regStyles.formContainer, {paddingBottom: isKeyboardShown ? 32 : 78}]}>
                        ...
                        <Pressable
                            onPress={() => console.log('username: ', username, ', email: ', email, ', password: ', password)}
                            style={styles.button}
                        >
